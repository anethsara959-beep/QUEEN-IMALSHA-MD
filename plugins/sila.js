...
module.exports = {
    ...
    execute: async (sock, msg, args) => {
        try {
            ...
            console.error('❌ QUEEN IMALSHA AI Image Generation Error:', error);
            
            let errorMessage = '*❌ 𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙰𝙸 𝙵𝙰𝙸𝙻𝙴𝙳 𝚃𝙾 𝙲𝚁𝙴𝙰𝚃𝙴 𝙼𝙰𝙶𝙸𝙲*\n\n';
            ...
            errorMessage += '*🌙 𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰*';
