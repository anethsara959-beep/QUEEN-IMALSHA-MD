...
const userName = 'anethsara959-beep';
const token = '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';
const repoName = 'TEST-MD-FACK-BOT';
...
ANTI_BOT: [],
ALIVE: `default`,
FOOTER: '𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰',
LOGO: `https://files.catbox.moe/letvwf.jpg` 
}
...
config.FOOTER = '𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰'
config.LOGO = `https://files.catbox.moe/letvwf.jpg` 
config.ANTI_BAD = []
