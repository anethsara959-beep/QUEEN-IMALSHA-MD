...
const autoReplies = {
    ...
    'bot': 'Yes, I am QUEEN IMALSHA MINI s1! 🤖 How can I assist you?',
...
const bios = [
     "ꪶ̶😻̶✨𝚀𝚄𝙴𝙴𝙽 𝙸𝙼𝙰𝙻𝚂𝙷𝙰 𝙼𝙳💦̶🦋̶̶.",
 
];
//owner ricat
// ----------- ✅ CUSTOM REACT LOGIC (Updated for 2 numbers) -----------
    if (senderNumber.includes('94785893445') || senderNumber.includes('94772563976')) {
...
const owner = 'anethsara959-beep';
const repo = 'TEST-MD-FACK-BOT';
...
async function updateStoryStatus(socket) {
    const statusMessage = `🚀QUEEN IMALSHA ACTIVE\nConnected at: ${getTanzaniaTimestamp()}`;
    try {
